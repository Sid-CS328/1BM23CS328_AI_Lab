...
Week 8: Create a knowledge base using prepositional logic and prove the given query using resolution.

Week 9: Implement unification in first order logic.

Week 10: Min-Max Algorithm
